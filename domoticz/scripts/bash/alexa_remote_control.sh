...
encryptionKey="$SCRIPTPATH/lib/credentialsKey.pem"
# Enable for use encryption (then disable same vairable below):
#SET_EMAIL=$(getVariable "alexaEmail")
#SET_PASSWORD=$(getPassword $encryptionKey "alexaPwd")
...
#SET_REFRESH_TOKEN='Atnr|EwICINxUYBWbFFyQumiPxlHQjTrTEnYFC6sqHPvSe...'

SET_LANGUAGE='es,es-ES;q=0.7,en;q=0.3'
#SET_LANGUAGE='en-US'

SET_TTS_LOCALE='es-ES'
...
DEVLIST="${TMP}/.alexa.devicelist.txt"
